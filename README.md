# OSLTT - Open Source Peripheral Testing Tool 
An open source peripheral testing tool project - here you'll find the desktop software needed to use the tool, the firmware for the device, the circuit diagram and support. 


<a href="https://osrtt.com" target="_blank">![Buy a kit](buy-a-kit.png)</a>

## Get Started
- Download the most recent release from the <a href="https://github.com/OSRTT/OSPTT/releases/latest">releases page</a>.
- Run the installer, which will install to C:\OSPTT
- Launch the software
